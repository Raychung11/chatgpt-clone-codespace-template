...
<head>
  ...
  <title>Page Not Found — SilverDeals MY</title>
...
<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;background:var(--orange-bg);padding:var(--space-xl);">
  <div style="text-align:center;max-width:480px;">
    ...
    <h1 style="font-size:64px;color:var(--orange-primary);font-weight:800;line-height:1;margin-bottom:var(--space-sm);">404</h1>
