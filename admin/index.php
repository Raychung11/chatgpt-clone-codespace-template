...
$routes = [
    ...
    'menu'                => 'pages/menu.php',
    'menu/category/create'=> 'pages/menu_category_form.php',
    'menu/category/edit'  => 'pages/menu_category_form.php',
    'menu/item/create'    => 'pages/menu_item_form.php',
    'menu/item/edit'      => 'pages/menu_item_form.php',
