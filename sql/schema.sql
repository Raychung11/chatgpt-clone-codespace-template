...
('byteplus_endpoint_id',       '', 'string', 'BytePlus Endpoint ID — Seedance 1.5 Lite 5s (ep-xxx)',  'api'),
('byteplus_endpoint_id_10s',   '', 'string', 'BytePlus Endpoint ID — Seedance 1.5 Pro 10s (ep-xxx)',  'api'),
